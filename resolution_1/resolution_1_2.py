...
ax1.axvline(x=1900, color='red')
ax1.axvline(x=1220, color='blue')
ax2 = fig.add_subplot(512) 
ax2.set_ylabel('DT')
ax2.yaxis.set_label_position("right")
log_data.plot('DEPTH', 'DTC', ax=ax2, color='blue', sharex=True,subplots=True,legend=False)
ax2.axvline(x=1900, color='red')
ax2.yaxis.tick_right()
ax2.axvline(x=1220, color='blue')
ax3 = fig.add_subplot(513) 
ax3.set_ylabel('GR')
log_data.plot('DEPTH', 'GR', color='black', ax=ax3, sharex=True,subplots=True,legend=False)
ax3.axvline(x=1900, color='red')
ax3.axvline(x=1220, color='blue')
...
ax4.axvline(x=1900, color='red')
ax4.axvline(x=1220, color='blue')
