...
makecpt -Cetopo1 -T-11000/8550/100 -Z -D > res.cpt
grdimage /home/mxh909/Documents/global_data/ETOPO1_Bed_g_gmt4.grd $location $prj -Cres.cpt -K -P > $filename
psxy coords.txt $location $prj -K -O -W1,red >> $filename
psscale -D6.75i/4.4i/5i/0.5i -Cetopo1 -O -K -Ba1000t1000g1000 >> $filename
